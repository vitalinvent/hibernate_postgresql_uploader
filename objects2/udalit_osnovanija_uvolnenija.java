...
@Entity
@Table(name="udalit_osnovanija_uvolnenija")
public class udalit_osnovanija_uvolnenija implements Serializable {

public udalit_osnovanija_uvolnenija(){}

public udalit_osnovanija_uvolnenija(String _guid){ this.guid=UUID.fromString(_guid); }
