...
@Entity
@Table(name="stroki_otchetnosti_rashodov_i_chislennosti_rabotnikov_gosudarstvennih_organov")
public class stroki_otchetnosti_rashodov_i_chislennosti_rabotnikov_gosudarstvennih_organov implements Serializable {

public stroki_otchetnosti_rashodov_i_chislennosti_rabotnikov_gosudarstvennih_organov(){}

public stroki_otchetnosti_rashodov_i_chislennosti_rabotnikov_gosudarstvennih_organov(String _guid){ this.guid=UUID.fromString(_guid); }
