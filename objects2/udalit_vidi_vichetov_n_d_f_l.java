...
@Entity
@Table(name="udalit_vidi_vichetov_n_d_f_l")
public class udalit_vidi_vichetov_n_d_f_l implements Serializable {

public udalit_vidi_vichetov_n_d_f_l(){}

public udalit_vidi_vichetov_n_d_f_l(String _guid){ this.guid=UUID.fromString(_guid); }
