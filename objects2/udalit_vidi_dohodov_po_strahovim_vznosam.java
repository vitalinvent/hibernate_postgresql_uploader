...
@Entity
@Table(name="udalit_vidi_dohodov_po_strahovim_vznosam")
public class udalit_vidi_dohodov_po_strahovim_vznosam implements Serializable {

public udalit_vidi_dohodov_po_strahovim_vznosam(){}

public udalit_vidi_dohodov_po_strahovim_vznosam(String _guid){ this.guid=UUID.fromString(_guid); }
