...
@Entity
@Table(name="vidi_otpravljaemih_dokumentov")
public class vidi_otpravljaemih_dokumentov implements Serializable {

public vidi_otpravljaemih_dokumentov(){}

public vidi_otpravljaemih_dokumentov(String _guid){ this.guid=UUID.fromString(_guid); }
