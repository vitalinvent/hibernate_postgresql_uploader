...
@Entity
@Table(name="vidi_tarifov_strahovih_vznosov")
public class vidi_tarifov_strahovih_vznosov implements Serializable {

public vidi_tarifov_strahovih_vznosov(){}

public vidi_tarifov_strahovih_vznosov(String _guid){ this.guid=UUID.fromString(_guid); }
