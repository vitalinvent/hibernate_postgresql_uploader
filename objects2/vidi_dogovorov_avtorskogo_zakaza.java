...
@Entity
@Table(name="vidi_dogovorov_avtorskogo_zakaza")
public class vidi_dogovorov_avtorskogo_zakaza implements Serializable {

public vidi_dogovorov_avtorskogo_zakaza(){}

public vidi_dogovorov_avtorskogo_zakaza(String _guid){ this.guid=UUID.fromString(_guid); }
