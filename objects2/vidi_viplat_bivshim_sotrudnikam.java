...
@Entity
@Table(name="vidi_viplat_bivshim_sotrudnikam")
public class vidi_viplat_bivshim_sotrudnikam implements Serializable {

public vidi_viplat_bivshim_sotrudnikam(){}

public vidi_viplat_bivshim_sotrudnikam(String _guid){ this.guid=UUID.fromString(_guid); }
