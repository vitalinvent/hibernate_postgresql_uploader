...
@Entity
@Table(name="osnovanija_dosrochnogo_naznachenija_pensii")
public class osnovanija_dosrochnogo_naznachenija_pensii implements Serializable {

public osnovanija_dosrochnogo_naznachenija_pensii(){}

public osnovanija_dosrochnogo_naznachenija_pensii(String _guid){ this.guid=UUID.fromString(_guid); }
