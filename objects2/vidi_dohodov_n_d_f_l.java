...
@Entity
@Table(name="vidi_dohodov_n_d_f_l")
public class vidi_dohodov_n_d_f_l implements Serializable {

public vidi_dohodov_n_d_f_l(){}

public vidi_dohodov_n_d_f_l(String _guid){ this.guid=UUID.fromString(_guid); }
...
private vidi_vichetov_n_d_f_l vichet_po_umolchaniyu;

public vidi_vichetov_n_d_f_l getVichet_po_umolchaniyu(){ try{return this.vichet_po_umolchaniyu;}catch(Exception ex){ return null;} }

public void setVichet_po_umolchaniyu( Object _vichet_po_umolchaniyu){if (_vichet_po_umolchaniyu instanceof String){this.vichet_po_umolchaniyu= new vidi_vichetov_n_d_f_l (_vichet_po_umolchaniyu.toString());}else{try{this.vichet_po_umolchaniyu= (vidi_vichetov_n_d_f_l) _vichet_po_umolchaniyu;}catch(Exception ex){Variables.logger.error(ex);this.vichet_po_umolchaniyu= new vidi_vichetov_n_d_f_l (_vichet_po_umolchaniyu.toString());}}}
...
public vidi_vichetov_n_d_f_l getVichet_po_umolchaniyu_obj(){ return this.vichet_po_umolchaniyu; }

public void setVichet_po_umolchaniyu_obj( Object _vichet_po_umolchaniyu){ this.vichet_po_umolchaniyu=(vidi_vichetov_n_d_f_l) _vichet_po_umolchaniyu; }
