...
@Entity
@Table(name="viruchka")
public class viruchka implements Serializable {

public viruchka(){}

public viruchka(String _guid){ this.guid=UUID.fromString(_guid); }
...
public viruchka( String data , UUID vid_nomenklaturi , UUID pokazatel , UUID sklad , UUID kontragent , Float znachenie , UUID organizatsija , UUID nomenklatura  String data , UUID vid_nomenklaturi , UUID pokazatel , UUID sklad , UUID kontragent , Float znachenie , UUID organizatsija , UUID nomenklatura ){}
